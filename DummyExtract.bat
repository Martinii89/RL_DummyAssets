...
set DummyFolder=C:\Projects\Unreal\RL\UPK-stuff\RL_DummyAssets
...
AssetExtraction.exe --nopreload --dummy -f %CookedPCConsolePath% --dummyFolder %DummyFolder%\Maps\Dunk_House -g Hoops*.upk
